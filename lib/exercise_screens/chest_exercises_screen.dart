...
class _ChestExercisesScreenState extends State<ChestExercisesScreen> {
  ...
  void _loadCustomWorkouts() async {
    ...
    setState(() {
      customWorkouts = prefs.getStringList('customChestWorkouts') ?? [];
    });
  }
  ...
  void _loadFavorites() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      favoriteWorkouts = prefs.getStringList('favoriteChestWorkouts') ?? [];
    });
  }
  ...
  void _toggleFavorite(String name) async {
    ...
    await prefs.setStringList('favoriteChestWorkouts', favoriteWorkouts);
  }
  ...
  void _addToRecent(String name) async {
    ...
    await prefs.setStringList('recentChestWorkouts', recentWorkouts);
  }
  ...
  void _addCustomWorkout(String workout) async {
    ...
    await prefs.setStringList('customChestWorkouts', customWorkouts);
  }
