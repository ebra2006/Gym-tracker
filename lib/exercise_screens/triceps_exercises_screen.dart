...
// بيانات التمارين
  ...
  void _toggleFavorite(String name) async {
    ...
    setState(() {
      ...
      prefs.setStringList('favoriteTricepsWorkouts', favoriteWorkouts);
    });
  }
  ...
  void _addToRecent(String name) async {
    ...
    setState(() {
      ...
      prefs.setStringList('recentTricepsWorkouts', recentWorkouts);
    });
  }
  ...
  void _addCustomWorkout(String workout) async {
    ...
    prefs.setStringList('customTricepsWorkouts', customWorkouts);
  }
