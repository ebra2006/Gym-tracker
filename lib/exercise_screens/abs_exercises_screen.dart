...
class _AbsExercisesScreenState extends State<AbsExercisesScreen> {
  ...
  void _loadCustomWorkouts() async {
    ...
    setState(() {
      customWorkouts = prefs.getStringList('customAbsWorkouts') ?? [];
    });
  }
  ...
  void _loadFavorites() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      favoriteWorkouts = prefs.getStringList('favoriteAbsWorkouts') ?? [];
    });
  }
  ...
  void _loadRecent() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      recentWorkouts = prefs.getStringList('recentAbsWorkouts') ?? [];
    });
  }
  ...
  void _toggleFavorite(String name) async {
    ...
    setState(() {
      ...
      prefs.setStringList('favoriteAbsWorkouts', favoriteWorkouts);
    });
  }
  ...
  void _addToRecent(String name) async {
    ...
    setState(() {
      ...
      prefs.setStringList('recentAbsWorkouts', recentWorkouts);
    });
  }
  ...
  void _addCustomWorkout(String workout) async {
    ...
    prefs.setStringList('customAbsWorkouts', customWorkouts);
  }
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                await prefs.setStringList('customAbsWorkouts', customWorkouts);
  ...
  String getWorkoutImage(String name) {
    switch (name) {
      ...
      case 'Cardio':
        return 'assets/images/cardio.png';
      case 'Legs':
