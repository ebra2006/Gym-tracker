...
// بيانات التمارين
  ...
  void _toggleFavorite(String name) async {
    ...
    setState(() {
      ...
      prefs.setStringList('favoriteCardioWorkouts', favoriteWorkouts);
    });
  }
  ...
  void _addToRecent(String name) async {
    ...
    setState(() {
      ...
      prefs.setStringList('recentCardioWorkouts', recentWorkouts);
    });
  }
  ...
  void _addCustomWorkout(String workout) async {
    ...
    prefs.setStringList('customCardioWorkouts', customWorkouts);
  }
