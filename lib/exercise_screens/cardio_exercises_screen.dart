...
class CardioExercisesScreen extends StatefulWidget {
  ...
  @override
  State<CardioExercisesScreen> createState() => _CardioExercisesScreenState();
}
...
class _CardioExercisesScreenState extends State<CardioExercisesScreen> {
  ...
  void _loadCustomWorkouts() async {
    ...
    setState(() {
      customWorkouts = prefs.getStringList('customCardioWorkouts') ?? [];
    });
  }
  ...
  void _loadFavorites() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      favoriteWorkouts = prefs.getStringList('favoriteCardioWorkouts') ?? [];
    });
  }
  ...
  void _loadRecent() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      recentWorkouts = prefs.getStringList('recentCardioWorkouts') ?? [];
    });
  }
  ...
  void _toggleFavorite(String name) async {
    ...
    await prefs.setStringList('favoriteCardioWorkouts', favoriteWorkouts);
  }
  ...
  void _addToRecent(String name) async {
    ...
    await prefs.setStringList('recentCardioWorkouts', recentWorkouts);
  }
  ...
  void _addCustomWorkout(String workout) async {
    ...
    await prefs.setStringList('customCardioWorkouts', customWorkouts);
  }
    ...
    Navigator.of(context).push(
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) {
          return CardioWorkoutDetailsScreen(categoryName: name);
        },
