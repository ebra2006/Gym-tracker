...
class ShouldersExercisesScreen extends StatefulWidget {
  ...
  @override
  State<ShouldersExercisesScreen> createState() =>
      _ShouldersExercisesScreenState();
}
...
class _ShouldersExercisesScreenState extends State<ShouldersExercisesScreen> {
  ...
  void _loadCustomWorkouts() async {
    ...
    setState(() {
      customWorkouts = prefs.getStringList('customShouldersWorkouts') ?? [];
    });
  }
  ...
  void _loadFavorites() async {
    ...
    setState(() {
      favoriteWorkouts = prefs.getStringList('favoriteShouldersWorkouts') ?? [];
    });
  }
  ...
  void _loadRecent() async {
    ...
    setState(() {
      recentWorkouts = prefs.getStringList('recentShouldersWorkouts') ?? [];
    });
  }
  ...
  void _toggleFavorite(String name) async {
    ...
    await prefs.setStringList('favoriteShouldersWorkouts', favoriteWorkouts);
  }
  ...
  void _addToRecent(String name) async {
    ...
    await prefs.setStringList('recentShouldersWorkouts', recentWorkouts);
  }
  ...
  void _addCustomWorkout(String workout) async {
    ...
    await prefs.setStringList('customShouldersWorkouts', customWorkouts);
  }
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                await prefs.setStringList(
                  'customShouldersWorkouts',
                  customWorkouts,
                );
                await prefs.setStringList(
                  'favoriteShouldersWorkouts',
                  favoriteWorkouts,
                );
                await prefs.setStringList(
                  'recentShouldersWorkouts',
                  recentWorkouts,
                );
