...
// بيانات التمارين
  ...
  void _toggleFavorite(String name) async {
    ...
    setState(() {
      ...
      prefs.setStringList('favoriteShouldersWorkouts', favoriteWorkouts);
    });
  }
  ...
  void _addToRecent(String name) async {
    ...
    setState(() {
      ...
      prefs.setStringList('recentShouldersWorkouts', recentWorkouts);
    });
  }
  ...
  void _addCustomWorkout(String workout) async {
    ...
    prefs.setStringList('customShouldersWorkouts', customWorkouts);
  }
