...
// بيانات التمارين
  ...
  void _toggleFavorite(String name) async {
    ...
    setState(() {
      ...
      prefs.setStringList('favoriteLegsWorkouts', favoriteWorkouts);
    });
  }
  ...
  void _addToRecent(String name) async {
    ...
    setState(() {
      ...
      prefs.setStringList('recentLegsWorkouts', recentWorkouts);
    });
  }
  ...
  void _addCustomWorkout(String workout) async {
    ...
    prefs.setStringList('customLegsWorkouts', customWorkouts);
  }
