...
class _LegsExercisesScreenState extends State<LegsExercisesScreen> {
  ...
  void _loadCustomWorkouts() async {
    ...
    setState(() {
      customWorkouts = prefs.getStringList('customLegsWorkouts') ?? [];
    });
  }
  ...
  void _loadFavorites() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      favoriteWorkouts = prefs.getStringList('favoriteLegsWorkouts') ?? [];
    });
  }
  ...
  void _loadRecent() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() {
      recentWorkouts = prefs.getStringList('recentLegsWorkouts') ?? [];
    });
  }
  ...
  Future<void> _loadGenderAndSetCategories() async {
    ...
    if (gender == 'Male') {
      categories = [
        {'name': 'barbell squat', 'image': 'assets/images/legs.png'},
        {'name': 'leg press', 'image': 'assets/images/legs.png'},
        {'name': 'leg extension', 'image': 'assets/images/legs.png'},
      ];
    } else {
      categories = [
        {'name': 'barbell squat', 'image': 'assets/female/legs.png'},
        {'name': 'leg press', 'image': 'assets/female/legs.png'},
        {'name': 'leg extension', 'image': 'assets/female/legs.png'},
      ];
    }
  ...
  void _toggleFavorite(String name) async {
    ...
    await prefs.setStringList('favoriteLegsWorkouts', favoriteWorkouts);
  }
  ...
  void _addToRecent(String name) async {
    ...
    await prefs.setStringList('recentLegsWorkouts', recentWorkouts);
  }
  ...
  void _addCustomWorkout(String workout) async {
    ...
    await prefs.setStringList('customLegsWorkouts', customWorkouts);
  }
